...
jobs_data = [
  ...
  },
  {
    ...
    description: "Maintenance de premier niveau, contrôle des équipements et assistance technique dans l'établissement. Polyvalence, réactivité et sens du service requis."
  },
  {
    title: "Équipier polyvalent",
    description: "Mise en place, aide au service, entretien des espaces et assistance aux équipes de l'établissement. Adaptabilité, rigueur et esprit d'équipe requis."
  }
]
